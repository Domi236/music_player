<?php
/* get Duration for music files */

// $mp3file = new Duration("assets\music\♪ Nightcore - Look What You Made Me Do.mp3");//http://www.npr.org/rss/podcast.php?id=510282
// $duration1 = $mp3file->getDurationEstimate();//(faster) for CBR only
// $duration2 = $mp3file->getDuration();//(slower) for VBR (or CBR)
// echo Duration::formatTime($duration1)."\n" . '<br>';
